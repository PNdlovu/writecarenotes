/**
 * @writecarenotes.com
 * @fileoverview On-Call Management Dashboard Component
 * @version 1.0.0
 * @created 2025-01-02
 ...
 *
 * Description:
 * Mobile-first dashboard component for the on-call management system.
...
interface OnCallDashboardProps extends BaseCareProps {
    careHome: CareHome;
    organization: Organization;
}

export const OnCallDashboard: React.FC<OnCallDashboardProps> = observer(({ 
    careHome, 
    organization,
    person,
    careType 
