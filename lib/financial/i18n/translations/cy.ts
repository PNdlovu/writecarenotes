export const cy = {
  ...
  errors: {
    network: {
      offline: 'Rydych chi all-lein ar hyn o bryd',
      syncFailed: 'Methodd y cydamseru',
      retrying: 'Yn ailgeisio...'
    },
    validation: {
      required: 'Mae {{field}} yn ofynnol',
      invalid: '{{field}} annilys',
      minLength: 'Rhaid i {{field}} fod o leiaf {{min}} nod',
      maxLength: 'Ni all {{field}} fod yn fwy na {{max}} nod',
      number: 'Rhaid i {{field}} fod yn rhif',
      positive: 'Rhaid i {{field}} fod yn gadarnhaol',
      date: 'Rhaid i {{field}} fod yn ddyddiad dilys',
      email: 'Cyfeiriad e-bost annilys',
      phone: 'Rhif ffôn annilys'
    },
    permissions: {
      unauthorized: 'Mynediad heb awdurdod',
      forbidden: 'Mynediad wedi\'i wahardd',
      insufficientRights: 'Hawliau annigonol i gyflawni\'r weithred hon'
    },
    system: {
      general: 'Digwyddodd gwall. Ceisiwch eto.',
      maintenance: 'Mae\'r system dan gynnal a chadw',
      timeout: 'Amser wedi dod i ben ar y cais'
    }
  }
};
