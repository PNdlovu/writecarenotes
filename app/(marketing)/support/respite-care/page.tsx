...
const features = [
  {
    title: 'Short-term Care Support',
    description: 'Comprehensive care coverage for temporary periods, ensuring continuity of care.',
    icon: Clock,
    color: 'text-blue-600',
    bgColor: 'bg-blue-50'
  },
  {
    ...
    description: 'Scheduled respite periods to support primary caregivers with their own needs.',
    icon: Calendar,
  ...
  },
  {
    ...
    description: 'Rapid response care support for unexpected situations and emergencies.',
    icon: Heart,
    color: 'text-red-600',
    bgColor: 'bg-red-50'
  },
  {
    ...
    description: 'Engaging social programs to keep residents active and entertained during their stay.',
    icon: Users,
  ...
  },
  {
    ...
    description: 'Comfortable and welcoming settings that help residents feel at ease.',
    icon: Home,
  ...
  },
  {
    ...
    description: 'Tailored care plans that maintain consistency with regular routines.',
    icon: HandHeart,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
              Supporting caregivers with professional temporary care services while ensuring continuity of care for your loved ones.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-8 md:p-12 text-center text-white shadow-xl">
            ...
            <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
              Discover how our respite care services can support both caregivers and residents.
            </p>
