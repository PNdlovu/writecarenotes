/**
 * @writecarenotes.com
 * @fileoverview Domiciliary schedule API route handler with offline sync
 * @version 1.0.0
 * @created 2024-03-21
 * @updated 2024-03-21
 ...
 *
 * Description:
 * API route handler for domiciliary care schedules with offline sync capabilities.
 * Supports CRUD operations with offline-first architecture and data sync.
 */
...
const offlineService = new OfflineService('domiciliary-schedules');
