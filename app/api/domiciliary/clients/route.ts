/**
 * @writecarenotes.com
 * @fileoverview Domiciliary clients API route handler with offline sync
 * @version 1.0.0
 * @created 2024-03-21
 * @updated 2024-03-21
 ...
 *
 * Description:
 * API route handler for domiciliary care clients with offline sync capabilities.
...
const offlineService = new OfflineService('domiciliary-clients');
